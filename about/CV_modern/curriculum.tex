...
\iconhref{Home}{16}{geospatial.netlify.app}{https://geospatial.netlify.app/}{black}\\[5pt]
...
\cvskill{Docker} {3+ years} {0.5} \\[-2pt]
...
%	PROFILE
%----------------------------------------------------------------------------------------
\cvsection{Data Scientist and Researcher}
\vspace{4pt}

Problem-solving addict, researcher, and data scientist with publications in international journals. Worked and solved problems in a range of domains, such as the automotive industry, medical image analysis, banking, dynamic pricing, and geotemporal data science. \\

Driven towards creating algorithms, mathematical models, data processing pipelines, and analyzing bottlenecks and code performance, I specialize in creating prototypes and algorithms to solve relevant problems, communicating results to a diverse audience—from neophytes to stakeholders—iterating over the prototypes, and managing the handover to the development team for production.
...
{June 2020 - today}
	...
	{
		• Developing prototypes to automate spatiotemporal data analysis at scale. Python (scikit-learn, pandas, numpy, streamlit), OpenAPI, Docker, K8s, DeckGl, \href{https://kepler.gl/}{KeplerGl}, git (github, gitlab), AGILE development, CI/CD automation.\\
		• Collaborating with clients and domain experts to quickly and iteratively integrate feedback into prototypes. \\
		• Prototypes handover to production and DevSecOps teams. \\
		• Developing and \href{https://github.com/thegeneralsystem}{open sourcing} python libraries to provide users tooling and examples for the \href{https://www.generalsystem.com/product}{Data Flow Index}.\\
		• Contributing to the \href{https://www.generalsystem.com/blog}{company blog} aimed at building a community around the hot topics of spatiotemporal data science. \\
	}
\vfill\null
...
{Sept 2019 - June 2020}
	...
	{
		• Simulation and Validation team, aimed at validate and test the python-based ETL pipelines and the core algorithms with Python, Dask, SQLAlchemy. \\
		• Production code maintenance and new features integration.\\
	}
\vfill\null
...
{Oct 2018 - June 2019}
	...
	{
		• State-of-the-art infrastructure technologies to deploy microservices in a cloud-agnostic environment: Python, Go, Docker, Kubernetes, and derived customisations.\\
		• Maintenance and improvement of the Thought Machine's CI/CD and release pipelines.\\
	}
\vfill\null
...
{Sept 2014 - Sept 2018}
	...
	{Research Student}
	{
		• Pre-clinical trial on pre-term birth steroids administration in a multi-disciplinary international research team.\\
...
{March 2013 - June 2014}
	...
	{
		• Material flow simulation models to estimate efficiency, remove bottlenecks, dimension buffers and support plant layout design for a range of clients in Italy and Germany. Siemens PlantSimulation, SimTalk. \\
		• In house shortest paths algorithms development for the internal and external logistics of assembly parts, from plant's gate to assembly line.\\
		• Presented at the first annual Tecnomatix Plant Simulation User Conference in Stuttgart.\\
	}
\vfill\null
...
{June 2011 - Oct 2011}
	...
	{
		• Term contracts as Junior Developer in Java, Java J2EE, Struts 2, Uml, Python. \\
		• Algorithms developer: prototyped and implemented a generalised Hungarian Algorithm to parse newspapers' pages. \\
	}
\vfill\null
...
\today, public \href{https://geospatial.netlify.app/about/CV_modern/curriculum.pdf}{downloadable CV}. \hspace{1cm}   \hrulefill
